  ...
  return (
    <div className="wrap">
      <header className={"pl4"}>
        <a href="https://alistapart.com/article/learning-from-lego-a-step-forward-in-modular-web-design">
          based on Learning from Lego
        </a>
      </header>

      <div className={myStyles.flexHorizontalGreen}>
        <div>One</div>
        <div>Two</div>
        <div>Three</div>
      </div>

      <h1 className={myStyles.ooooClass}>Hello world with ooooClass</h1>
            ...
            <div className="flex col structure-2-2">
              ...
              <div className="flex element h">
                <div className="content">
                  H &nbsp;
                  <button className={myStyles.niceColors}>SUBMIT</button>
                </div>
              </div>
            </div>
          </div>
